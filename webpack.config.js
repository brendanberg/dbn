    ...
    devServer: {
        ...
        headers: {
            'Content-Security-Policy':
                "default-src * http://localhost:8080; style-src * https://fonts.googleapis.com 'unsafe-inline'; script-src * 'unsafe-inline'; connect-src * https://dbn.berg.industries ws://localhost:8080; object-src *;",
