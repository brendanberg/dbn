...
VM.prototype.redraw = function () {
    this.frame
        ...
        .putImageData(this.imageData, 0, 0, 0, 0, this.imageData.width, this.imageData.height);
...
VM.prototype.readPixel = function (x, y) {
    if (x >= this.imageData.width || x < 0 || y >= this.imageData.height || y < 0) {
        return;
    }
...
VM.prototype.grayscale = function (r, g, b) {
    ...
    function grayscale(r, g, b) {
        return sRGB_gamma(rY * inv_sRGB_gamma(r) + gY * inv_sRGB_gamma(g) + bY * inv_sRGB_gamma(b));
    }
...
VM.prototype.writePixel = function (x, y) {
    // r, g, b) {
    if (x >= this.imageData.width || x < 0 || y >= this.imageData.height || y < 0) {
        return;
    }
...
VM.prototype.fillCanvas = function () {
    //r, g, b) {
